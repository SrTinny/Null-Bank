...
// Pegando a matrícula do caixa que está logado
$matricula = $_SESSION['login_funcionario'];

// Obtendo nome e id da agência do caixa que está logado
...
if ($stmt->execute()) {
    ...
    // Obtendo nome da agência do caixa que está logado
    ...
    <main class="main">
        <section class="section-info">
            <div class="info-conta">
                <img class="icon" src="../imagens/user.png" alt="Ícone do usuário">
                <div>
            ...
            <div class="info-conta">
                <img class="icon" src="../imagens/company.png" alt="Ícone da agência">
                <div>
        ...
        <section class="cotent-area">
            <div class="subtitle-divider">
                ...
                <div class="scroll-area">
                    <?php
                    // Obtendo num_conta das contas da agência do caixa que está logado
                    ...
                    if ($stmt->execute()) {
                        ...
                        foreach ($retorno_consulta as $tupla) {
                            ...
                            // Obtendo todas os atributos da tabela Transacao
                ...
                <div class="scroll-area">
                    ...
                    if ($stmt->execute()) {
                        ...
                        foreach ($retorno_consulta as $tupla) {
                            ...
                            // Tratando o valor que vem do banco para uma melhor exibição
                            $tipo_conta2 = "";
                            ...
                            // Obtendo o CPF do dono da conta em questão
                            ...
                            if ($stmt->execute()) {
                                ...
                                // Obtendo o nome do dono da conta questão
    ...
    <div class="modal-overlay">
        <div class="modal">
            ...
            <form class="modal-form" action="../php/transacao_caixa.php" method="POST">
                <label for="num_conta" class="label-form">Número da conta</label>
